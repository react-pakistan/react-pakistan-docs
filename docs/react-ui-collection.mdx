...
<div>
  <img src="https://res.cloudinary.com/dq6hflqwx/image/upload/v1671950784/React%20Pakistan/react-ui-collection.jpg" width="70%"/>
  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQY1K6JwhYEBfsv52nUT30dAIjoFyp252cH6VVkhXB_Gq1bUSz-" width="20%" />
</div>

- [React UI Storybook Playground](https://react-ui-collection.surge.sh/?path=/docs/react-pakistan-intro--page/)
...
You could either use the default theme as shown below or wire your custom theme object instead. See <a href="https://react-ui-collection.surge.sh/?path=/story/ecommercev1ui-styleguide-typography--typography-story&globals=measureEnabled:false">Typography</a> & <a href="https://react-ui-collection.surge.sh/?path=/story/ecommercev1ui-styleguide-colors--colors-story&globals=measureEnabled:false">Colors</a> being used in the theme object.
...
<iframe
  ...
  width="100%"
  src="https://react-ui-collection.surge.sh/?path=/story/ecommercev1ui-breadcrumbs--breadcrumbs-story">
</iframe>
...
<iframe
  ...
  width="100%"
  src="https://react-ui-collection.surge.sh/?path=/story/ecommercev1ui-cartsummary--cart-summary-story">
</iframe>
...
<iframe
  ...
  width="100%"
  src="https://react-ui-collection.surge.sh/?path=/story/ecommercev1ui-cart--cart-story">
</iframe>
...
<iframe
  ...
  width="100%"
  src="https://react-ui-collection.surge.sh/?path=/story/ecommercev1ui-categorybanner--category-banner-story">
</iframe>
...
<iframe
  ...
  width="100%"
  src="https://react-ui-collection.surge.sh/?path=/story/ecommercev1ui-categorycard--category-card-story">
</iframe>
...
<iframe
  height='500'
  id='React Pakistan - React UI Collection Avatar'
  src='https://react-ui-collection.surge.sh/?path=/story/resume-avatar--avatar-story'
  title='React Pakistan - React UI Collection Avatar'
  width='100%'>
</iframe>
...
<iframe
  height='500'
  id='React Pakistan - React UI Collection AvatarBlock'
  src='https://react-ui-collection.surge.sh/?path=/story/resume-avatarblock--avatar-block-story'
  title='React Pakistan - React UI Collection AvatarBlock'
  width='100%'>
</iframe>
...
<iframe
  height='500'
  id='React Pakistan - React UI Collection BioBlock'
  src='https://react-ui-collection.surge.sh/?path=/story/resume-bioblock--bio-block-story'
  title='React Pakistan - React UI Collection BioBlock'
  width='100%'>
</iframe>
...
<iframe
  height='500'
  id='React Pakistan - React UI Collection CardGrid'
  src='https://react-ui-collection.surge.sh/?path=/story/resume-cardgrid--card-grid-story'
  title='React Pakistan - React UI Collection CardGrid'
  width='100%'>
</iframe>

...
sidebar_label: React Native UI Collection
---
...
<div>
  <img src="https://res.cloudinary.com/dq6hflqwx/image/upload/v1583650649/GitHub/react-native-ui-collection.jpg" width="70%"/>
  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQY1K6JwhYEBfsv52nUT30dAIjoFyp252cH6VVkhXB_Gq1bUSz-" width="20%" />
</div>

- [React Native UI NPM Module](https://www.npmjs.com/package/@react-pakistan/react-native-ui-collection)
...
`yarn add @react-pakistan/react-native-ui-collection` or `npm install @react-pakistan/react-native-ui-collection`

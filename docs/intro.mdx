...
although we have a ton of UI packages i.e. MaterialUI, AntD and so many others but none of them allow full
customisation as per your client's design specs.
...
Extending upon them, we built several production apps, for instance React UI Collection.
